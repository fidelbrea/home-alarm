 ...
 */
package lipermi.call;

import java.io.Serializable;

/**
 * Class that holds informations about a remote instance, making the instance
 * unique in all remote JVM. All remote instances have a generated random UUID,
 * except the global ones (registered with
 * {@link lipermi.handler.CallHandler#registerGlobal CallHandler}).
 *
 * @date 05/10/2006
 * @author lipe
 */
