...
public class CallProxy implements InvocationHandler {
    ...
    /**
     * Create new CallProxy with a ConnectionHandler which will transport
     ...
     * Build a proxy to a {
     *
     * @see lipermi.call.RemoteInstance RemoteInstance} specifing how it could
     * be reached (i.e., through a ConnectionHandler)
     *
