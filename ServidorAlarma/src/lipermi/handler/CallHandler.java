...
/**
 * A handler who know a RemoteInstance and its local implementations. Used to
 * delegate calls to correct implementation objects.
 *
 * Local implementation objects must register with methods
 * {@link lipermi.handler.CallHandler#registerGlobal registerGlobal} and
 * {@link lipermi.handler.CallHandler#exportObject exportObject} to work
 * remotelly.
 *
 * @author lipe
 * @date 05/10/2006
 *
 * @see	lipermi.call.RemoteInstance
 */
